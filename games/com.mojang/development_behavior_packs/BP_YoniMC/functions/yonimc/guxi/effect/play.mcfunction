...
execute if score @s var_0 matches 881 run scoreboard players operation @s arg_0 = speed_affact_energy_multiplier_min guxi:values
execute if score @s var_0 matches 881 run scoreboard players operation @s arg_1 = speed_affact_energy_multiplier_max guxi:values
