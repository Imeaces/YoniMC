...
scoreboard players set mining_affact_energy_multiplier_max guxi:values 142

#var default guxi:ef_damage -2
scoreboard players set default_damage_affect guxi:values -1
scoreboard players set damage_affact_energy_multiplier_min guxi:values 49
scoreboard players set damage_affact_energy_multiplier_max guxi:values 752
