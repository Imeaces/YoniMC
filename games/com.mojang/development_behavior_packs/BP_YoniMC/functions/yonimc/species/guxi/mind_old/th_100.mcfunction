...
##enter => back
execute if entity @s[scores={mind:enter=1}] run function yonimc/species/guxi/mind_old/goto/goto_1
execute if entity @s[scores={mind:op101=0,mind:v102=1}] run function yonimc/species/guxi/mind_old/goto/goto_1
execute if entity @s[scores={mind:op101=!0,mind:v102=0}] run scoreboard players set @s mind:v102 1

# 如果在其他的特定位置则跳转到对应的功能
# (3,3) 快速调节
execute if entity @s[scores={mind:op100=9}] run function yonimc/species/guxi/mind_old/goto/goto_100400
