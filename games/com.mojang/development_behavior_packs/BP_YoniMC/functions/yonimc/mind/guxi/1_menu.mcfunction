...
execute if score @s var_0 matches 1 run titleraw @s actionbar {"rawtext":[{"translate":"§7%%s§f|%%s","with":{"rawtext":[{"score":{"objective":"guxi:energy","name":"@s"}},{"score":{"objective":"guxi:energy_pool","name":"@s"}}]}}]}
