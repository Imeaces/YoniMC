...
## 当检测到血量损失，根据损失失去能量
execute @s[scores={guxi:lostHealth=1..}] ~ ~ ~ function guxi/event_lost_health
## 满足一定条件时，恢复血量
execute @s[scores={guxi:disHealth=1..,guxi:sEnergy=..3}] ~ ~ ~ function guxi/action_cure_health
