...
execute @s[scores={plight:type=1}] ~ ~ ~ scoreboard players set @s plight 14
...
execute @s[scores={plight:type=91}] ~ ~ ~ scoreboard players set @s plight 15
execute @s[scores={plight:type=213}] ~ ~ ~ scoreboard players set @s plight 3
execute @s[scores={plight:type=771}] ~ ~ ~ scoreboard players set @s plight 5
execute @s[scores={plight:type=116}] ~ ~ ~ scoreboard players set @s plight 7
