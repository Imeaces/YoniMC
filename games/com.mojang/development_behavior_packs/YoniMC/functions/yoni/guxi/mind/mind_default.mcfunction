...
execute @s[scores={mind:v100=100410}] ~ ~ ~ function yoni/guxi/mind/th_100410
...
execute @s[tag=guxi:event_adding_energy,scores={guxi:op5=0..50}] ~ ~ ~ fill ~-1 ~ ~-1 ~1 ~ ~1 obsidian 0 replace lava
execute @s[tag=guxi:event_adding_energy,scores={guxi:op5=0..70}] ~ ~ ~ fill ~-1 ~ ~-1 ~1 ~ ~1 stone 0 replace flowing_lava

execute @s[tag=guxi:event_adding_energy,scores={guxi:op5=0..500}] ~ ~ ~ fill ~-1 ~ ~-1 ~1 ~ ~1 air 0 replace fire

execute @s[tag=guxi:event_adding_energy,scores={guxi:op5=0}] ~ ~ ~ fill ~-3 ~ ~-3 ~3 ~ ~3 obsidian 0 replace lava
execute @s[tag=guxi:event_adding_energy,scores={guxi:op5=0}] ~ ~ ~ fill ~-2 ~ ~-2 ~2 ~ ~2 stone 0 replace flowing_lava
execute @s[tag=guxi:event_adding_energy,scores={guxi:op5=0}] scoreboard players add @s guxi:energies 10
