...
scoreboard objectives add mind:op102 dummy
scoreboard players set @s mind:op102 0

scoreboard objectives add mind:op103 dummy
scoreboard players set @s mind:op103 0
