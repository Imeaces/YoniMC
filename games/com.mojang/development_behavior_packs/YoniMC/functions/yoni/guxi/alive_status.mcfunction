...
# 能量附加的状态
## 能量恢复活跃
execute @s [scores={guxi:order=..0,guxi:status=!4}] ~ ~ ~ scoreboard players set @s guxi:order 1
## 能量瘫痪
execute @s [scores={guxi:order=!0,guxi:status=4}] ~ ~ ~ scoreboard players set @s guxi:order 0
## 主动能量附加
### 力量
