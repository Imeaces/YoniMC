...
## 当检测到血量损失，根据损失失去能量
execute @s[scores={guxi:v101=1..}] ~ ~ ~ function yoni/guxi/action_lost_health
## 添加护盾
execute @s[scores={guxi:v100=..0,guxi:v101=1..}] ~ ~ ~ function yoni/guxi/event_first_lost_health
## 满足一定条件时，恢复血量
execute @s[scores={guxi:status=..3}] ~ ~ ~ function yoni/guxi/play_cure_health
