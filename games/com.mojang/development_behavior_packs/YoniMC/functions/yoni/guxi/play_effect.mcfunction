...
# strength
execute @s[scores={guxi:strength=1},tag=guxi:att] ~ ~ ~ effect @s strength 3 4 true
execute @s[scores={guxi:strength=1},tag=guxi:att] ~ ~ ~ scoreboard players remove @s guxi:energy 862280
