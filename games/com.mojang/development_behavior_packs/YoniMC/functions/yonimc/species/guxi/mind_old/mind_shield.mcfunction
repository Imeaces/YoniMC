...
execute if entity @s[scores={mind:slot=2}] run scoreboard players set @s mind:lock 1
execute if entity @s[scores={mind:slot=!2}] run scoreboard players set @s mind:lock 0
execute if entity @s[scores={mind:slot=!2}] run scoreboard players operation @s guxi:resistance = @s mind:v200
execute if entity @s[scores={mind:slot=!2}] run scoreboard players set @s mind 0
