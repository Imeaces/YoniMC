...
execute if score @s var_0 matches -201 run scoreboard players set @s md:timer_076 0
...
execute if score @s mind matches 1 unless score @s md:timer_076 matches 0..4 run scoreboard players set @s var_0 -301
execute if score @s mind matches 1 if score @s md:timer_076 matches 0..4 run scoreboard players set @s var_0 -300

execute if score @s var_0 matches -300 run scoreboard players add @s md:timer_076 1
execute if score @s var_0 matches -300 run titleraw @s actionbar {"rawtext":[{"translate":"%%s§f%%s%%s%%s","with":{"rawtext":[{"translate":"§r%%2","with":{"rawtext":[{"selector":"@s[scores={guxi:pp_energy=..30}]"},{"text":"§l"}]}},{"score":{"objective":"guxi:energy_pool","name":"@s"}},{"translate":"§o§7|§r%%s%%s","with":{"rawtext":[{"translate":"%%2","with":{"rawtext":[{"selector":"@s[scores={guxi:pp_energy=..30}]"},{"text":"§f"},{"text":"§7"}]}},{"score":{"objective":"guxi:energy","name":"@s"}}]}},{"translate":"%%2","with":{"rawtext":[{"selector":"@s[scores={md:timer_076=1..}]"},{"translate":"\n>>%%s","with":{"rawtext":[{"score":{"objective":"md:timer_076","name":"@s"}}]}}]}}]}}]}
