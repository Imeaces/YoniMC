...
#执行想法
execute @s[scores={mind:scene=-1}] ~ ~ ~ function yoni/guxi/mind/play_scene

execute @s[scores={mind:scene=0}] ~ ~ ~ function yoni/guxi/mind/mind_default
execute @s[scores={mind:scene=1}] ~ ~ ~ function yoni/guxi/mind/mind_attack
execute @s[scores={mind:scene=2}] ~ ~ ~ function yoni/guxi/mind/mind_shield
execute @s[scores={mind:scene=3}] ~ ~ ~ function yoni/guxi/mind/mind_gliding
