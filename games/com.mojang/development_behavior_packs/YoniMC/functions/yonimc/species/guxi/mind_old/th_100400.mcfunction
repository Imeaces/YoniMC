...
#计算与进入视角的偏移值
function yonimc/species/guxi/mind_old/operation/rotate_y_offset
...
## 第二行
execute if entity @s[rxm=-30] run scoreboard players add @s mind:op100 3
## 第三行
execute if entity @s[rxm=31] run scoreboard players add @s mind:op100 3
## 第二列
execute if entity @s[scores={op:ory1=-30..}] run scoreboard players add @s mind:op100 1
## 第三列
execute if entity @s[scores={op:ory1=31..}] run scoreboard players add @s mind:op100 1

# 保存初始位置到mind:v101，初始位置始终显示退出按钮
execute if entity @s[scores={mind:v101=0}] run scoreboard players operation @s mind:v101 = @s mind:op100
...
##end
execute if entity @s[scores={mind:op101=0,mind:v102=1}] run function yonimc/species/guxi/mind_old/goto/goto_100
execute if entity @s[scores={mind:op101=!0,mind:v102=0}] run scoreboard players set @s mind:v102 1
