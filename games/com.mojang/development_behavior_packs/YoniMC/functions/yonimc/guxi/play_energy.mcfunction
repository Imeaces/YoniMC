...
##0 可惜能量已经不够了
execute if score @s guxi:pp_energy matches 0 run kill @s
execute if score @s guxi:pp_energy matches 0 run tellraw @a {"rawtext":[{"translate":"%%s 消散了", "with":{"rawtext":[{"selector":"@s"}]}}]}
