...
#-1 no need to deal
execute if score @s alive matches -1 if score @s yoni:guxi matches 0 run scoreboard players set @s var_0 -1
execute if score @s alive matches -1 if score @s yoni:guxi matches -20 run scoreboard players set @s var_0 -1

# if unexpected kill and reset
execute if score @s var_0 matches 0 run tell @s 意料之外的情况
execute if score @s var_0 matches 0 run kill @s
execute if score @s var_0 matches 0 run kill @s
