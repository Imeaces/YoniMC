...
export class MiraiSession {
    ...
    async post(url, contents={}, headers={}, retryCount = 2){
        ...
        throw Object.assign(new Error("failed to post request"),
            { cause: error });
    }
    ...
    async getSession(force = false, retryCount = 1){
        ...
        if (this.#sessionKey == null){
            ...
            try {
                ...
                throw Object.assign(new Error("failed to getting a session"),
                    {cause: e});
            }
        }
        ...
        do {
            ...
            try {
                ...
                error = Object.assign(new Error("unable to check the session info"),
                    {cause: e});
                continue;
            }
