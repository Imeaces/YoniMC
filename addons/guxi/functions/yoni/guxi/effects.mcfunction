...
execute @s[scores={guxi:effective=..-2}] ~ ~ ~ effect @s slowness 2 255 true
execute @s[scores={guxi:effective=4..}] ~ ~ ~ effect @s speed 2 0 true

# visitable by vision (-1..1)
execute @s[scores={guxi:vision=..-1,guxi:effective=..-2}] ~ ~ ~ effect @s blindness 2 0 true
...
execute @s[scores={guxi:strength=3,guxi:effective=-1..0}] ~ ~ ~ effect @s strength 2 0 true
execute @s[scores={guxi:strength=4..,guxi:effective=-1}] ~ ~ ~ effect @s strength 2 0 true
...
execute @s[scores={guxi:strength=4..,guxi:effective=3..}] ~ ~ ~ effect @s strength 2 8 true
...
execute @s[scores={guxi:resistance=1,guxi:effective=-1..}] ~ ~ ~ effect @s resistance 2 0 true
execute @s[scores={guxi:resistance=2,guxi:effective=0..}] ~ ~ ~ effect @s resistance 2 1 true
execute @s[scores={guxi:resistance=3,guxi:effective=2..}] ~ ~ ~ effect @s resistance 2 2 true
execute @s[scores={guxi:resistance=4..,guxi:effective=4..}] ~ ~ ~ effect @s resistance 2 3 true
